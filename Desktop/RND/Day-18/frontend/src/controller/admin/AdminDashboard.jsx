        ...
        return (
            ...
            <nav style={{ width: '250px', backgroundColor: '#2c3e50', padding: '20px', color: '#fff', boxShadow: '2px 0 10px rgba(0,0,0,0.1)' }}>
                ...
                style={{ 
                    ...
                    padding: '12px',
                    marginBottom: '10px',
                    backgroundColor: activeTab === 'userlist' ? '#3498db' : '#34495e',
                    color: '#fff',
                    border: 'none',
                    borderRadius: '5px',
                    cursor: 'pointer',
            ...
            <div style={{ flex: 1, padding: '20px', backgroundColor: '#ecf0f1', height: '95vh', overflowY: 'auto' }}>
                {activeTab === 'home' && <div><h1 style={{ color: '#2c3e50' }}>{`Welcome ${usernameContext}, this is Admin Dashboard`}</h1></div>}
